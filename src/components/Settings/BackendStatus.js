  ...
  if (apiGetState.errorMessage) {
    ...
    return (
      <div className="container mb-5">
        ...
        <p>Development Mode: {apiGetState.server.development_mode ? "true" : "false"}</p>
        <p>Backend Version: {apiGetState.server.version}</p>
        <p>ACME Production Directory: {apiGetState.server.acme_directories.prod}</p>
        <p>ACME Staging Directory: {apiGetState.server.acme_directories.staging}</p>
